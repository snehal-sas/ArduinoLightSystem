...
**I used an Arduino Uno Rev3 microcontroller to build a light system that, using servos, flips a light switch on or off everytime someone trips the motion detectors.**
